...
**Asset Path**: `/Game/VRGamePlay/BeginnersGuide/TriggerBox/UseMove.UseMove`
...
* Event Actual Function
    * Call Parent: [ActualFunction](#bp-beginnersguidetriggerbox-actualfunction)()
        * VRPawn.Call Custom Event: [BP_VRPawn.MoveGuide](#bp-vrpawn-moveguide)()
            * [Path ends after call to custom event "BP_VRPawn.MoveGuide"]
```
---
...
- /Game/VRGamePlay/Player/BP_VRPawn.SKEL_BP_VRPawn_C (SKEL_BP_VRPawn_C) // ActualFunction :: Move Guide
