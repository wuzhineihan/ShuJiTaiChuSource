# BP_ActorCanBeGrab_Child5

**Asset Path**: `/Game/VRGamePlay/Projectile/Blueprint/CanNotBreak/BP_ActorCanBeGrab_Child5.BP_ActorCanBeGrab_Child5`

---

## Metadata

- **Class**: BP_ActorCanBeGrab_Child5
