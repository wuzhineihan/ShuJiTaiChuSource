# BP_ActorCanBeGrab_Child

**Asset Path**: `/Game/VRGamePlay/Projectile/Blueprint/CanNotBreak/BP_ActorCanBeGrab_Child.BP_ActorCanBeGrab_Child`

---

## Metadata

- **Class**: BP_ActorCanBeGrab_Child
