...
**Asset Path**: `/Game/VRGamePlay/Scene/Torches/BP_PitFire.BP_PitFire`
...
- Niagara : NiagaraComponent (Parent: StaticMesh)
...
- /Script/Niagara.NiagaraComponent (NiagaraComponent) // Component: Niagara
